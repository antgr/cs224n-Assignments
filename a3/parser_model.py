...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        #self.embed_to_hidden =nn.Linear(,self.hidden_size)
    ...
    def embedding_lookup(self, t):
        ...
        embeddings_t = self.pretrained_embeddings(t)
        x = embeddings_t.view(list(t.size())[0],-1)
    ...
    def forward(self, t):
        ...
        embed_batch = self.embedding_lookup(t)
        second = self.embed_to_hidden(embed_batch)
        relu = F.relu(second)
